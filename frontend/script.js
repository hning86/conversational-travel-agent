    ...
    switch (card.type) {
        ...
        case "map_card":
            ...
            cardDiv.innerHTML = `
                ...
                <img src="/map_mockup.svg" class="map-svg" style="width: 100%; border-radius: 14px; border: 1px solid rgba(0,0,0,0.1); box-shadow: 0 4px 15px rgba(0,0,0,0.05); height: auto; display: block;" alt="Route to Sister's Flat" />
            `;
            break;
